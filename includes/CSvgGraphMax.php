...
use CSvg;
use CSvgGraphAxis;
use CSvgGraphClipArea;
use CSvgGraphGrid;
use CSvgGraphMetricsBar;
use CSvgGraphMetricsLine;
use CSvgGraphMetricsPoint;
use CSvgGraphPercentile;
use CSvgGraphProblems;
use CSvgGraphSimpleTrigger;
use CSvgGraphWorkingTime;
use CSvgLine;
use CSvgRect;
use CSvgTag;
use CSvgText;
...
class CSvgGraphMax extends CSvg {

	public const SVG_GRAPH_X_AXIS_HEIGHT = 10;
	...
	public function addSimpleTriggers(array $simple_triggers): self {
		$this->simple_triggers = $simple_triggers;

		return $this;
	}

	public function addProblems(array $problems): self {
