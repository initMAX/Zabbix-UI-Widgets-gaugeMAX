...
<div align="center">
    ...
    <h4>
        This widget extends features of the "Gauge" widget by displaying the history using a background graph.
    </h4>
    <br>
    ...
    <br>
    <img src="./.readme/screen/widget.png" width="1000"> <!-- !!! change version !!! -->
</div>
<br>
<br>
...
Minimum required Zabbix version 7.0
...
<h3>
    Get the PRO version at <a href="mailto:info@initmax.com?subject=Inquiry%20gaugeMAX%20PRO%20version">info@initmax.com</a>
</h3>
</div>
...
- Clone repository on your server <!-- !!! repository !!! -->
    ```sh
    git clone https://git.initmax.cz/initMAX-Public/Zabbix-UI-Widget-gaugeMAX.git
    ``` 
...
- Change the owner of directory to your web user with `chown`
  - choose default OS user
    - nginx
        ```sh
        chown nginx:nginx ./Zabbix-UI-Widgets-gaugeMAX
        ``` 
    - apache
        ```sh
        chown apache:apache ./Zabbix-UI-Widgets-gaugeMAX
        ``` 
    - www-data
        ```sh
        chown www-data:www-data ./Zabbix-UI-Widgets-gaugeMAX
        ``` 
