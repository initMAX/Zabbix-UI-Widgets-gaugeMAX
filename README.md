...
<img src="./.readme/badge/version.svg" alt="version 2.0.7">
...
<img src="./.readme/screen/01-overview.png" width="880" alt="Multiple gauges turn current infrastructure values into a dashboard that can be scanned at a glance.">
...
<table>
<tr>
<td width="50%" align="center" valign="top"><img src="./.readme/screen/02-cpu.png" alt="Cpu"><br><small><b>Cpu</b> - CPU utilization is shown against meaningful operating ranges, with the active value clearly highlighted.</small></td>
<td width="50%" align="center" valign="top"><img src="./.readme/screen/03-memory.png" alt="Memory"><br><small><b>Memory</b> - Memory utilization uses the same consistent visual language for quick comparison across resources.</small></td>
</tr>
<tr>
<td width="50%" align="center" valign="top"><img src="./.readme/screen/04-cache.png" alt="Cache"><br><small><b>Cache</b> - Cache metrics remain compact while preserving the thresholds needed for operational decisions.</small></td>
<td width="50%" align="center" valign="top"><img src="./.readme/screen/05-disk.png" alt="Disk"><br><small><b>Disk</b> - Disk usage becomes an immediate capacity signal instead of another value hidden in a table.</small></td>
</tr>
</table>
...
<div align="center">
<img src="./.readme/screen/06-settings.png" width="440" alt="gaugeMAX configuration">
</div>
...
<div align="center">
<a href="https://portal.initmax.com/catalog/zabbix-gaugemax#how-to-install"><img src="./.readme/screen/portal-installer.png" width="100%" alt="Guided installer on the initMAX Portal - click to open"></a>
</div>
