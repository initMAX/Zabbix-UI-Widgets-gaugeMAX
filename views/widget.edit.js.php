...
window.widget_form = new class extends CWidgetForm {
    ...
    addLogo() {
        ...
        el.classList.add('initmax-gaugemax-logo');
    ...
    #updateForm() {
        ...
        for (const element of this.#form.querySelectorAll(
            '#units, #units_pos, #units_size, #units_bold, .color-picker[color-field-name="units_color"]'
        )) {
        ...
        this.#form.querySelector('.color-picker[color-field-name="needle_color"]').disabled =
